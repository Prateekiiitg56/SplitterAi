/* Adapted from ThreeUI source SHA bc9f07ae6da3.
   Changed: import from "three" instead of "three128" to use the project's
   existing Three.js r185. The GLSL shaders and bead logic are unchanged. */
