...
export const mockAgents: AgentInfo[] = [
  {
    ...
    logs: [
      { id: 'pl1', timestamp: '10:41:58', type: 'model_request', role: 'planner', model: 'gemini/gemini-3.5-flash', message: 'Planning task decomposition…' },
  ...
  },
  {
    ...
    lastActive: 'now',
    logs: [
      { id: 'c1', timestamp: '10:42:01', type: 'subtask_start', role: 'coder', subtaskId: 'sub-1', model: 'gemini/gemini-3.5-flash', message: 'Starting: Create fizzbuzz.py' },
      { id: 'c2', timestamp: '10:42:02', type: 'model_fallback', role: 'coder', subtaskId: 'sub-3', model: 'openrouter/nvidia/nemotron-3-super-120b-a12b:free', message: 'gemini rate-limited → openrouter nemotron-3 fallback' },
    ...
    subtasks: [
      { id: 'sub-1', role: 'coder', group: 1, instruction: 'Create fizzbuzz.py', status: 'success', model: 'gemini/gemini-3.5-flash', durationMs: 7200, steps: 3, output: 'Created fizzbuzz.py — verified output.' },
      { id: 'sub-2', role: 'coder', group: 1, instruction: 'Create fibonacci.py', status: 'success', model: 'gemini/gemini-3.5-flash', durationMs: 5100, steps: 2, output: 'Created fibonacci.py — iterative approach.' },
      { id: 'sub-3', role: 'coder', group: 1, instruction: 'Create factorial.py', status: 'running', model: 'openrouter/nvidia/nemotron-3-super-120b-a12b:free', steps: 2, startedAt: '10:42:01' },
    ],
  },
  {
    role: 'auditor',
    ...
    lastActive: 'now',
    logs: [
      { id: 'a1', timestamp: '10:42:10', type: 'subtask_start', role: 'auditor', subtaskId: 'sub-5', model: 'xai/grok-2-beta', message: 'Starting: Code review' },
    ...
    subtasks: [
      { id: 'sub-5', role: 'auditor', group: 2, instruction: 'Review all three scripts for code quality and PEP 8', status: 'running', model: 'xai/grok-2-beta', steps: 1, startedAt: '10:42:10' },
    ],
  },
  {
    role: 'tester',
    ...
    lastActive: 'now',
    logs: [
      { id: 't1', timestamp: '10:42:10', type: 'subtask_start', role: 'tester', subtaskId: 'sub-4', model: 'openrouter/nvidia/nemotron-3-super-120b-a12b:free', message: 'Starting: Run and verify scripts' },
    ...
    subtasks: [
      { id: 'sub-4', role: 'tester', group: 2, instruction: 'Run all three scripts and verify output', status: 'running', model: 'openrouter/nvidia/nemotron-3-super-120b-a12b:free', steps: 2, startedAt: '10:42:10' },
    ],
  },
]

/* ── Real Workspace Sessions ─────────────────────────────────── */

export const mockSessions: SessionEntry[] = [
  { id: 's1', workspace: 'd:/CodeForces/SplitterAi', task: 'Create fizzbuzz, fibonacci, and factorial scripts', status: 'executing', createdAt: '10:41 AM', subtaskCount: 5 },
  { id: 's2', workspace: 'd:/CodeForces/SplitterAi', task: 'Fix auth middleware for expired JWT tokens', status: 'done', createdAt: '9:15 AM', subtaskCount: 3 },
  { id: 's3', workspace: 'd:/CodeForces/SplitterAi', task: 'Add rate limiting to /api/v1 endpoints', status: 'done', createdAt: 'Yesterday', subtaskCount: 2 },
  { id: 's4', workspace: 'd:/CodeForces/SplitterAi', task: 'Audit login page for XSS vulnerabilities', status: 'done', createdAt: 'Yesterday', subtaskCount: 1 },
  { id: 's5', workspace: 'd:/CodeForces/SplitterAi', task: 'Write unit tests for the argument parser', status: 'error', createdAt: 'Aug 31', subtaskCount: 2 },
]
